...
class QM:
    ...
    def determine_qm(self):
        ...
        self.i_rest = self.itop[f'!(({self.qm_mask})|(!({ions_and_sol_mask})))']
    ...
    def make_hsd(self,file_hsd):
        ...
        "Rb": "Rb",
        "Cs": "Cs",
        "OW_spc": "O", "OW_tip4pew": "O", "OW_tip4p": "O", "OW_tip5p": "O",
        "HW_spc": "H", "HW_tip4pew": "H", "HW_tip4p": "H", "HW_tip5p": "H",
        "Li": "Li",
        "Zn": "Zn",
        "LA": "H",
